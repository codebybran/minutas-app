...
const FIELD_HELP = {
  // -- MUTUO CIVIL SIMPLE (NUEVO) --
  nombre_mutuante: 'Escriba el nombre completo de quien presta el dinero.',
  cedula_mutuante: 'Escriba el número de cédula del mutuante.',
  domicilio_mutuante: 'Escriba la ciudad donde vive el mutuante.',
  nombre_mutuario: 'Escriba el nombre completo de quien recibe el préstamo.',
  cedula_mutuario: 'Escriba el número de cédula del mutuario.',
  domicilio_mutuario: 'Escriba la ciudad donde vive el mutuario.',
  valor_prestamo_letras: 'Escriba el valor del préstamo en letras. Ej: cinco millones de pesos.',
  valor_prestamo_numeros: 'Escriba el valor del préstamo en números. Ej: 5.000.000.',
  forma_entrega_dinero: 'Describa cómo se entrega el dinero. Ej: en efectivo, mediante transferencia bancaria.',
  forma_pago_cuotas: 'Describa cómo se devolverá el dinero. Ej: un solo pago, o cuotas mensuales de $500.000.',
  direccion_notificacion_mutuante: 'Dirección donde el mutuante recibirá notificaciones.',
  direccion_notificacion_mutuario: 'Dirección donde el mutuario recibirá notificaciones.',
  // -- CONTRATO DE MANDATO (NUEVO) --
  cedula_mandante: 'Escriba el número de cédula de quien encarga la gestión.',
  domicilio_mandante: 'Escriba la ciudad donde vive el mandante.',
  domicilio_mandatario: 'Escriba la ciudad donde vive el mandatario.',
  tipo_mandato: 'Escriba si es un mandato general (para todos los negocios) o especial (para uno o más negocios específicos).',
  objeto_mandato: 'Describa con claridad qué gestión o negocio se encarga al mandatario.',
  con_representacion: 'Escriba sí, si el mandatario actuará en nombre del mandante frente a terceros; o no, si actuará en nombre propio.',
  remuneracion: 'Escriba si el mandato es gratuito o el valor que se pagará por el servicio.',
  duracion_mandato: 'Escriba cuánto tiempo durará el mandato, o hasta cuándo estará vigente.',
  direccion_notificacion_mandante: 'Dirección donde el mandante recibirá notificaciones.',
  direccion_notificacion_mandatario: 'Dirección donde el mandatario recibirá notificaciones.',
  // -- CESIÓN DE CRÉDITOS (NUEVO) --
  descripcion_credito: 'Describa el origen del crédito que se cede: de dónde viene, en qué consiste, la fecha del título.',
  valor_credito_letras: 'Escriba el valor del crédito en letras.',
  valor_credito_numeros: 'Escriba el valor del crédito en números.',
  precio_cesion_letras: 'Escriba el precio que se paga por la cesión, en letras. Si es gratuita, escriba: a título gratuito.',
  precio_cesion_numeros: 'Escriba el precio que se paga por la cesión, en números.',
  direccion_notificacion_cedente: 'Dirección donde el cedente recibirá notificaciones.',
  direccion_notificacion_cesionario: 'Dirección donde el cesionario recibirá notificaciones.',
  // -- ESTATUTOS DE ASOCIACIÓN (NUEVO) --
  nombre_asociacion: 'Escriba el nombre que tendrá la corporación o asociación.',
  domicilio_asociacion: 'Escriba la ciudad principal donde funcionará la asociación.',
  objeto_social: 'Describa los fines o propósitos que persigue la asociación.',
  duracion_asociacion: 'Escriba si la duración es indefinida o un número específico de años.',
  patrimonio_inicial: 'Describa el valor y origen de los aportes iniciales de los fundadores.',
  fundador_1_nombre: 'Escriba el nombre completo del primer fundador.',
  fundador_1_cedula: 'Escriba el número de cédula del primer fundador.',
  fundador_2_nombre: 'Escriba el nombre completo del segundo fundador.',
  fundador_2_cedula: 'Escriba el número de cédula del segundo fundador.',
  otros_fundadores: 'Si hay más fundadores, escriba sus nombres y cédulas. Si no hay más, escriba: Ninguno.',
  cedula_representante_legal: 'Escriba el número de cédula del representante legal inicial.',
  quorum_decisorio: 'Escriba con qué mayoría de votos se toman las decisiones en la Asamblea General. Ej: mayoría simple de los asociados.',
  destino_remanente: 'Escriba a qué entidad se entregarán los bienes sobrantes si la asociación se disuelve. Ej: a otra entidad sin ánimo de lucro de objeto similar.',
  ...
  calidad_demandante: 'Escriba la calidad en la que actúa el demandante frente al menor. Ej: cónyuge, compañero permanente, madre, o el hijo (impugnando su propia paternidad).',
  hechos_impugnacion: 'Describa las circunstancias que generan la duda sobre la paternidad. Ej: resultado de una prueba de ADN privada, ausencia de convivencia en la época de la concepción, u otro hecho relevante.',
  fecha_conocimiento: 'Escriba la fecha exacta en que el demandante se enteró del hecho que hace dudar de la paternidad. Es la fecha desde la cual empieza a contarse el plazo legal de 140 días para impugnar. Ej: el 10 de enero de 2026.',
  ...
  nombre_companero_1: 'Nombre completo del primer compañero(a) permanente, tal como aparece en su cédula.',
  cedula_companero_1: 'Número de cédula del primer compañero(a) permanente. Solo los números.',
  expedicion_companero_1: 'Ciudad donde fue expedida la cédula del primer compañero(a) permanente.',
  estado_civil_anterior_1: 'Estado civil que tenía el primer compañero(a) antes de esta unión. Ej: soltero, divorciado, viudo.',
  nombre_companero_2: 'Nombre completo del segundo compañero(a) permanente, tal como aparece en su cédula.',
  cedula_companero_2: 'Número de cédula del segundo compañero(a) permanente. Solo los números.',
  expedicion_companero_2: 'Ciudad donde fue expedida la cédula del segundo compañero(a) permanente.',
  estado_civil_anterior_2: 'Estado civil que tenía el segundo compañero(a) antes de esta unión. Ej: soltero, divorciado, viudo.',
  domicilio_comun: 'Dirección donde conviven actualmente los compañeros permanentes.',
  declarar_sociedad_patrimonial: 'Escriba sí o no. Indica si además de declarar la unión marital de hecho, también quieren declarar la existencia de la sociedad patrimonial entre ellos.',
  fecha_separacion: 'Fecha en que los compañeros permanentes se separaron o decidieron poner fin a la sociedad patrimonial. Ej: el 10 de febrero de 2026.',
  bienes_sociedad_patrimonial: 'Describa los bienes que conforman la sociedad patrimonial a distribuir. Ej: un vehículo marca Mazda 3 modelo 2019, placas ABC123, y los ahorros de la cuenta N°. 1234567890 del Banco de Bogotá.',
  forma_distribucion: 'Explique cómo se distribuyen los bienes entre los compañeros. Ej: cada uno conserva los bienes a su nombre; el vehículo queda para uno de ellos y los ahorros se dividen por partes iguales.',
  ...
  juzgado_alimentos: 'Escriba el nombre del juzgado que fijó la cuota alimentaria. Ej: Juzgado 2 de Familia.',
  ciudad_juzgado_alimentos: 'Escriba la ciudad donde se encuentra el juzgado que fijó la cuota alimentaria.',
  fecha_sentencia_alimentos: 'Escriba la fecha en que el juzgado dictó la sentencia que fijó la cuota alimentaria. Ej: el 12 de marzo de 2023.',
  tipo_solicitud: 'Escriba si solicita la exoneración total o la disminución de la cuota alimentaria.',
  cuota_propuesta: 'Si solicita disminución, escriba el valor de la nueva cuota mensual propuesta en números. Si solicita exoneración total, escriba: no aplica.',
  hechos_solicitud: 'Describa los hechos que justifican la solicitud. Ej: el menor alcanzó la mayoría de edad y no se encuentra estudiando, o el alimentante sufrió una disminución significativa en su capacidad económica.',
...
// -- DERECHO PENAL --
  ...
  'demanda-impugnacion-paternidad': {
    ciudad_firma: 'El Cerrito', nombre_abogado: 'Luis Fernando Gómez Torres',
    cedula_abogado: '0987654321', tarjeta_profesional: '123456-A',
    nombre_demandante: 'Jhon Brandon Martínez Vélez', cedula_demandante: '1234567890',
    calidad_demandante: 'presunto padre',
    nombre_menor: 'Samuel Martínez García', fecha_nacimiento_menor: 'el 5 de marzo de 2015',
    nombre_demandado: 'Alexander García López', cedula_demandado: '0987654321',
    ciudad_domicilio_demandado: 'El Cerrito',
    hechos_impugnacion: 'Una prueba de ADN practicada de forma privada el 5 de enero de 2026 arrojó un índice de exclusión de paternidad del 99.9%.',
    fecha_conocimiento: 'el 10 de enero de 2026',
    testigos: 'Alexander García López, Carrera 8 # 12-34, El Cerrito.',
    direccion_notificacion_abogado: 'Calle 10 # 5-67, oficina 201, El Cerrito',
  },
  'solicitud-exoneracion-reduccion-cuota-alimentaria': {
    ciudad_firma: 'El Cerrito', nombre_abogado: 'Luis Fernando Gómez Torres',
    cedula_abogado: '0987654321', tarjeta_profesional: '123456-A',
    nombre_solicitante: 'Jhon Brandon Martínez Vélez', cedula_solicitante: '1234567890',
    nombre_madre_representante: 'Laura Vanessa García Ríos',
    nombres_menores: 'Samuel Martínez García',
    juzgado_alimentos: 'Juzgado 2 de Familia', ciudad_juzgado_alimentos: 'El Cerrito',
    fecha_sentencia_alimentos: 'el 12 de marzo de 2020',
    cuota_fijada: '800.000',
    tipo_solicitud: 'la disminución',
    cuota_propuesta: '400.000',
    hechos_solicitud: 'El alimentante sufrió una reducción significativa en sus ingresos mensuales, debidamente certificada por su empleador, lo que hace imposible sostener la cuota fijada originalmente.',
    direccion_demandante: 'Carrera 8 # 12-34, El Cerrito',
    direccion_notificacion_abogado: 'Calle 10 # 5-67, oficina 201, El Cerrito',
  },
  'declaracion-union-marital-hecho-notarial': {
    ciudad: 'El Cerrito', departamento: 'Valle del Cauca', dia: '21', mes: 'abril', anio: '2026',
    notario: 'Única', circulo: 'El Cerrito',
    nombre_companero_1: 'Jhon Brandon Martínez Vélez', cedula_companero_1: '1234567890', expedicion_companero_1: 'El Cerrito', estado_civil_anterior_1: 'soltero',
    nombre_companero_2: 'Laura Vanessa García Ríos', cedula_companero_2: '0987654321', expedicion_companero_2: 'El Cerrito', estado_civil_anterior_2: 'soltera',
    fecha_inicio_union: 'el 15 de enero de 2018',
    domicilio_comun: 'Carrera 8 # 12-34, El Cerrito',
    declarar_sociedad_patrimonial: 'sí',
  },
  'disolucion-sociedad-patrimonial-umh-mutuo-consentimiento': {
    ciudad: 'El Cerrito', departamento: 'Valle del Cauca', dia: '21', mes: 'abril', anio: '2026',
    notario: 'Única', circulo: 'El Cerrito',
    nombre_companero_1: 'Jhon Brandon Martínez Vélez', cedula_companero_1: '1234567890', expedicion_companero_1: 'El Cerrito',
    nombre_companero_2: 'Laura Vanessa García Ríos', cedula_companero_2: '0987654321', expedicion_companero_2: 'El Cerrito',
    fecha_inicio_union: 'el 15 de enero de 2018',
    fecha_separacion: 'el 10 de febrero de 2026',
    bienes_sociedad_patrimonial: 'Un vehículo marca Mazda 3 modelo 2019, placas ABC123, y los ahorros de la cuenta de ahorros N°. 1234567890 del Banco de Bogotá.',
    forma_distribucion: 'Cada compañero conserva los bienes que están a su nombre; el vehículo queda en cabeza de Jhon Brandon Martínez Vélez y los ahorros se dividen por partes iguales.',
  },
  ...
  'constitucion-sas': {
    ...
    nombre_sociedad: 'Distribuidora Andina',
    domicilio_sociedad: 'El Cerrito',
    duracion_sociedad: 'indefinida',
    objeto_social: 'La comercialización y distribución de electrodomésticos y demás bienes de consumo, así como cualquier actividad comercial o civil lícita.',
    capital_autorizado_letras: 'cien millones de pesos', capital_autorizado_numeros: '100.000.000',
    numero_acciones: '10.000', valor_nominal_accion: '10.000',
    capital_suscrito_letras: 'cincuenta millones de pesos', capital_suscrito_numeros: '50.000.000',
    capital_pagado_letras: 'veinticinco millones de pesos', capital_pagado_numeros: '25.000.000',
    plazo_pago_capital: 'un (1) año',
    forma_administracion: 'La sociedad será administrada por un Representante Legal, sin necesidad de Junta Directiva.',
    nombre_representante_legal: 'Jhon Brandon Martínez Vélez', cedula_representante_legal: '1234567890',
    facultades_representante_legal: 'Amplias facultades de administración y disposición, incluyendo la de celebrar y ejecutar todos los actos y contratos comprendidos dentro del objeto social.',
    ciudad_arbitraje: 'Cali',
  },
...
'demanda-filiacion-natural': [
  ...
  'demanda-impugnacion-paternidad': [
    { num:1, titulo:'Verifique el plazo de 140 días', descripcion:'Si quien impugna es el cónyuge, compañero permanente o la madre, la demanda debe presentarse dentro de los 140 días siguientes a la fecha en que tuvo conocimiento de que no es el padre o madre biológico (Art. 216 C.C., modificado por la Ley 1060 de 2006). Si quien impugna es el hijo, puede hacerlo en cualquier tiempo.' },
    { num:2, titulo:'Solicite la prueba de ADN', descripcion:'La Ley 721 de 2001 establece que la prueba de ADN es la prueba reina en estos procesos. Un índice de probabilidad inferior al 99.9% de paternidad respalda la impugnación.' },
    { num:3, titulo:'Durante el proceso se presume la paternidad', descripcion:'Mientras no haya sentencia en firme, la ley presume que el registrado sigue siendo el padre. Si al final se declara la impugnación, quien impugnó puede reclamar indemnización de perjuicios (Art. 224 C.C.).' },
  ],
  'solicitud-exoneracion-reduccion-cuota-alimentaria': [
    { num:1, titulo:'Se tramita en el mismo expediente', descripcion:'Conforme al parágrafo 2° del artículo 390 del Código General del Proceso, la solicitud se presenta ante el mismo juez y en el mismo expediente que fijó la cuota, sin necesidad de conciliación prejudicial previa.' },
    { num:2, titulo:'Debe seguir pagando la cuota vigente', descripcion:'Mientras el juez no decida la solicitud, debe continuar pagando la cuota fijada originalmente. Dejar de pagarla antes de la decisión puede configurar el delito de inasistencia alimentaria.' },
    { num:3, titulo:'Reúna las pruebas del cambio de circunstancias', descripcion:'Certificados laborales, historia clínica, registros de estudio del menor u otros documentos que acrediten el hecho invocado (mayoría de edad sin estudiar, disminución de ingresos, etc.) son claves para la decisión del juez.' },
  ],
  'declaracion-union-marital-hecho-notarial': [
    { num:1, titulo:'Efectos legales', descripcion:'Desde la fecha de la escritura se reconoce la unión marital de hecho y, si así se declaró, la sociedad patrimonial entre los compañeros (Ley 54 de 1990, modificada por la Ley 979 de 2005).' },
    { num:2, titulo:'Trámite ante notario', descripcion:'Lleve la escritura a cualquier notaría del país, no necesariamente la del domicilio, y aporte las cédulas originales de ambos compañeros.' },
    { num:3, titulo:'Actualice registros con terceros', descripcion:'Aunque no es obligatorio inscribir la unión marital de hecho, puede ser conveniente informarla a la EPS, el fondo de pensiones o el empleador para efectos de beneficiarios.' },
  ],
  'disolucion-sociedad-patrimonial-umh-mutuo-consentimiento': [
    { num:1, titulo:'Solo aplica sin sentencia previa', descripcion:'Esta vía notarial solo es posible cuando ambos compañeros están de acuerdo y no hay conflicto sobre los bienes. Si hay desacuerdo, debe tramitarse ante un juez de familia.' },
    { num:2, titulo:'Efectos de la disolución', descripcion:'A partir de la fecha de la escritura cesa la sociedad patrimonial y cada compañero administra sus bienes de forma independiente, según la distribución acordada.' },
    { num:3, titulo:'Informe a terceros de buena fe', descripcion:'Notifique a bancos, entidades financieras y demás terceros con quienes existan obligaciones conjuntas, para evitar futuras confusiones patrimoniales.' },
  ],
  'demanda-declaracion-union-marital': [
  ...
  'constitucion-sas': [
    ...
    { num:2, titulo:'Inscríbalo en la Cámara de Comercio', descripcion:'La sociedad solo adquiere personalidad jurídica una vez se inscribe el documento de constitución en el Registro Mercantil de la Cámara de Comercio del domicilio principal (Art. 2 Ley 1258 de 2008). Antes de eso, se considera sociedad de hecho.' },
    { num:3, titulo:'El plazo de pago del capital no puede exceder 2 años', descripcion:'Si pactó un plazo para pagar el saldo del capital suscrito, recuerde que la ley no permite que exceda de dos (2) años desde la constitución (Art. 9 Ley 1258 de 2008).' },
  ],
  'constitucion-sociedad-anonima': [
